...
export function useTrends(id: number, limit?: undefined, config?: SWRConfiguration): UseTrendsReturn

export function useTrends(id: number, limit: number, config?: SWRConfiguration): FilteredUseTrendsReturn
